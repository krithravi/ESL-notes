...
\begin{itemize}
	\item \ita{La navidad es en diciembre} \arr Christmas is \textbf{in} December.
	\item \ita{La navidad es el 25 de diciembre} \arr Christmas is \textbf{on} December 25\textsuperscript{th}.
	\item \ita{Alejandro naci\'o en agosto} \arr Alejandro was born \textbf{in} August.
	\item \ita{Alejandro naci\'o el 4 de agosto} \arr Alejandro was born \textbf{on} August 4\textsuperscript{th}.
	\item \ita{El viernes, tengo que ir al dentista} \arr \textbf{On} Friday, I have to go to the dentist.
	\item \ita{Mark tiene que ir a clase los viernes.} \arr Mark has to go to class \textbf{on} Fridays. 
\end{itemize}
